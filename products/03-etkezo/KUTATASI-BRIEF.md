...
A jelenlegi [terméklista](README.md) összehasonlítási alap. A benne szereplő ajánlások felülvizsgálhatók; három TONSTAD-változat nem jelent három független asztalalternatívát.
...
## Kutatási és döntési módszer

1. A követelményeket rögzített feltételre, preferenciára és elfogadható kompromisszumra bontjuk. A nem teljesülő alapfeltétel kizárást jelent; a hiányzó adat ellenőrizendő marad.
2. Kategóriánként 4–6 releváns forrást vizsgálunk többféle forráscsoportból: nagy bútorlánc, lakberendezési márka, hazai gyártó vagy szaküzlet; igény szerint egyedi vagy használt kínálat. A jelenlegi IKEA-jelöltek is részt vesznek az összehasonlításban.
3. A kereskedő és a gyártó külön mező: ugyanaz a modell két boltban egy termékjelölt, két beszerzési lehetőséggel. A megvizsgált, de megfelelő találatot nem adó forrásokat is feljegyezzük.
4. Termékenként rögzítjük a pontos modellt/változatot, közvetlen linket, ellenőrzés dátumát, anyagot és szerkezetet, méreteket, árat, készletet és szállítási becslést. A marketingmegnevezést nem tekintjük anyagigazolásnak.
5. A csomagokat azonos darabszámmal és teljes bekerülési költséggel hasonlítjuk össze: asztal, szükséges székek, kötelező tartozékok, szállítás és szükség esetén szerelés. Az EUR-os ajánlatokat dátumozott, megnevezett árfolyammal becsüljük; nem kezeljük őket ingyenes vagy figyelmen kívül hagyható opciónak.
6. Legfeljebb három érdemi döntőst mutatunk be kategóriánként, rövid előnnyel, hátránnyal és kompromisszummal. A kizárt jelöltek indokai megmaradnak. A magasabb ár önmagában nem jelent jobb minőséget.
7. Az asztalt és a székeket együtt ellenőrizzük: lábak közötti hely, ülés- és karfamagasság, etetőszék elhelyezése, székkihúzás, közlekedés és fatónusok. A végső ajánlásnál külön jelezzük a mintához, méretellenőrzéshez vagy üléspróbához kötött pontokat.
8. A kutatás akkor zárható le, ha a releváns forráscsoportokat megvizsgáltuk és a legjobb jelöltek döntést befolyásoló adatai rendelkezésre állnak vagy hiányuk egyértelmű. Nem cél sem az IKEA kizárása, sem mesterséges márkaarány elérése.

## A kör eredménye

- Forrásnapló és rövid összehasonlítás a döntősökről.
- Egy ajánlott asztal–szék összeállítás és indokolt alternatívái, külön induló és végleges darabszámmal.
