# Háló – matrac, ágyrács és a fekhely teljes költsége
...
**2026-09-20-i párhuzamos kutatás eredménye:** a korábbi két kereskedőből összeadott példák mellé megvan egy ténylegesen együtt kínált tárolós csomag és egy olcsóbb, saját ágyrácsos fa keret. A következő sorok közül még egyik sem végleges rendelési javaslat.
...
## Matracok – azonos méret, eltérő szerkezet

Az árak a megnyitott magyar termékoldalak 180×200-as változatának árai. A webes ár nem foglalt készlet vagy címre vállalt szállítás; a MatracGuru oldalának keresőpéldánya régebbi, ezért ott az ár friss megerősítése is szükséges.

| Jelölt | Termékár | Szerkezet és tisztítás | Miért érdemes vizsgálni / mi hiányzik? |
| --- | --- | --- | --- |
| [RelaXx Hard Comfort – MatracGuru](https://www.matracguru.hu/termek/hard_comfort_hideghab_matrac) | **93 900 Ft** | Kemény hideghab, 16 cm teljes / 14 cm mag; levehető, 40 °C-on mosható huzat. | Az itt árazott matracok közül a legolcsóbb; a mosható huzat praktikus. A lapon szereplő **100 kg-os súlykorlátról nem derül ki, hogy személyenként értendő-e**. Két felnőttre alkalmasság, komfort, rácselőírás, aktuális ár/készlet és fuvar megerősítendő. Egyelőre figyelőlista. |
...
Egy 180-as matrac alatt két 90-es rács csak megfelelő középalátámasztással és a gyártói előírások teljesülésével használható. A névleges méret önmagában nem bizonyítja az illeszkedést.

| Jelölt | Darab / 2 darab | Adatlap szerinti kialakítás | Ellenőrzési hiány |
| --- | --- | --- | --- |
| [JYSK BALKJOSEN 90×200, 3554132](https://jysk.hu/haloszoba/agyak/agyalapok-agyracsok-agykeretek/agyracsok/hagyomanyos-agyracsok/agyracs-90x200-cm) | **12 500 / 25 000 Ft** | Nyírfurnér, 22 léc; tényleges méret **90×195×1 cm**, névleges fekvőméret 90×200. | Terhelhetőség, rögzítés és lamellaköz nem igazolt. A bolti értékelések között ismétlődő zaj-/stabilitási panaszok is vannak; ez ellenőrzési jelzés, nem bizonyított általános hiba. **Nem automatikus olcsó ajánlás.** |
| [JYSK HEMSIL FIX 90×200, 3529732](https://jysk.hu/haloszoba/agyak/agyalapok-agyracsok-agykeretek/agyracsok/hagyomanyos-agyracsok/keretes-agyracs-5) | **27 500 / 55 000 Ft** | Nyírfurnér, 26 léc, keretes; **90×200×7,5 cm**, szerelést igényel. | Befekvési mélység, középtámasz, terhelhetőség és lamellaköz ellenőrizendő az adott kerethez és matrachoz. A keretes kialakítás +30 000 Ft/pár; csak igazolt szerkezeti/komfortelőnyért indokolt. |

**Az Alguema, Ada és Anikó keret saját ágyrácsot tartalmaz:** ezekhez nem adunk még egyszer két külön rácsot. Az OLSKER és STUBBERUP mellé a fenti rácsok még nem igazolt párosítások; az azonos JYSK márka sem bizonyítja ezt.

## Csomagszámítások – feltételes termékárak, nem rendelési ajánlatok

| Összeállítás | Összeadás | Termékek részösszege |
| --- | --- | --- |
| OLSKER vagy STUBBERUP + BALKJOSEN pár + Hard Comfort | 115 000 + 25 000 + 93 900 | **233 900 Ft** |
...
- **IKEA:** a [90 éjszakás próba](https://www.ikea.com/hu/hu/customer-service/returns-claims/return-policy/) a kézhezvételtől számít, a 10 éves önkéntes jótállással kínált matracokra. Tiszta, sértetlen állapot és vásárlási bizonylat szükséges. Kibontott matrac vételárát **jóváírókártyára** térítik vissza; ezt nem kezeljük készpénzes visszafizetésként. Az esetleges visszafuvar díja külön ellenőrizendő. A 365 napos ajánlat csak bontatlan matracra vonatkozik.
- **JYSK:** a [100 napos GOLD-próba](https://jysk.hu/inspiration/probaljon-ki-egy-gold-matracot-100-napig-alhat-rajta) másik GOLD matracra történő cserét kínál, feltételekkel; az olcsóbbra váltás különbözete nem automatikus készpénz-visszatérítés. Ez nem minden JYSK-matracra érvényes. Az új körben a [DRIVA nagyon kemény 180×200](https://jysk.hu/haloszoba/matracok/rugos-matracok/rugos-matrac-180x200-cm-driva-nagyon-kemeny) **230 000 Ft** (okt. 13-ig), a [SVINNA félkemény 180×200](https://jysk.hu/haloszoba/matracok/habszivacs-matracok/habszivacs-matrac-180x200-cm-svinna-felkemeny) **429 900 Ft**. Mindkettő árazott próbatartalék; az ismert igények alapján még nincs igazolt előnyük, amely miatt a drágább csomagot előrevennénk.
- **Bútor Mirek:** [Lorenzo 180×200 H3](https://www.butormirek.hu/matracok/2412-zsakrugos-matrac-180x200-cm-7-zonas-h3-teli-nyari-oldal.html), **185 100 Ft**, zsákrugós, 7 zónás. Az oldalon „30.10–13.11” körüli készletjelzés látható: nincs tartalék az október 30-i beköltözés előtt, a kézbesítés pedig külön idő. Emiatt nem kerül a P1 rövidlistába. A 200 000 Ft feletti ingyenes fuvar e matrac önálló vásárlására nem alkalmazható automatikusan.
- **MatracGuru:** a fenti konkrét, mosható huzatú matrac ellenőrzött árforrás; otthoni komfortpróba, fuvar és modellre szóló készlet még nincs igazolva. A bolt általános készletígérete nem termékszintű vállalás.
- **Matrackuckó:** [szaküzleti próbahelyek](https://matrackucko.hu/uzleteink) bevonhatók. A keresésben előkerült fedőmatracok nem helyettesítik a teljes matracot; az ott hirdetett próba-/visszafizetési feltételeket nem visszük át más termékcsaládra. Megfelelő teljes 180×200-as változat és ár még szükséges.

## Illeszkedés a Wooden coastal irányhoz és a következő döntés
...
**Mindkettőtöknél milyen matracérzet vált be (puhább / közepes / kemény), és jellemzően oldalt, háton vagy hason alszotok?** Elég személyenként egy rövid válasz. A hozzávetőleges testsúlytartomány később a megengedett terhelés ellenőrzéséhez kell; nem vezetünk le pusztán a testsúlyból matracválasztást.
