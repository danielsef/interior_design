...
- Curtains: no external shutters/blinds; owner chose curtain hardware + light-filtering curtain + blackout curtain. Roller references excluded. Measure each opening; do not reuse the assumed 11 pairs/3 sets as an order.
- Wardrobe: full-height storage preferred if feasible; finished wall widths, height and mounting substrate unknown. Compare custom, adjustable-post and wall-track systems. No owned wardrobe confirmed.
- Bath/hand towels and folding clothes dryer are brought from the current home; exclude replacement candidates from new-purchase totals. Bath mats and towel holders are separate.
